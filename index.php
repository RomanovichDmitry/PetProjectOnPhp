...
$categoriesFind = [
        [
          'name' => '2014 Rossignol Distruct Snowboard',
          'price' => 10990,
        ...
        [
            'name' => 'Крепления Union Contact Pro',
            'price' => 8000,
            'category' => 'Крепления',
            'img' => 'img/lot-3.jpg'
        ],
...
<main class="container">
    ...
    <section class="lots">
        ...
        <ul class="lots__list">
            <?php foreach ($categoriesFind as $key => $value):?>
                ...
                <div class="lot__info">
                    ...
                    <div class="lot__state">
                        <div class="lot__rate">
                            ...
                            <span class="lot__cost"><?=calc($value['price'])?><b class="rub"></b></span>
                        </div>
